package com.schlaepfer.health.patientcommand.configuration;
...
import com.schlaepfer.health.patientcommand.aggregates.PatientAggregate;
...
/*    @Bean
    ...
    @Bean
	EventSourcingRepository<PatientAggregate> patientEventSourcingRepository() {
        EventSourcingRepository<PatientAggregate> repo = new EventSourcingRepository<PatientAggregate>(PatientAggregate.class, eventStore());
     ...
     */
    @Bean
    AggregateAnnotationCommandHandler<PatientAggregate> productAggregateCommandHandler() {
    	
    	AggregateAnnotationCommandHandler<PatientAggregate> handler = new AggregateAnnotationCommandHandler<PatientAggregate>(
                PatientAggregate.class,
                patientEventSourcingRepository(),
                commandBus());
        return handler;
    }
